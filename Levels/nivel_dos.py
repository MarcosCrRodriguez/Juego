...
class Nivel_Dos(Nivel):
    def __init__(self, pantalla:pygame.Surface) -> None:
        ...
        self.nivel_dos_completado = "Incompleto"
        ...
        diccionario_animaciones_armor_s["burst"] = enemy_burst
        ...
        super().__init__(pantalla, mi_personaje, armor, crabtank, lista_plataformas, lista_colision_plataformas, lista_enemigos,
                         ...
                         (1730,100),(100, 560), 90, corazones, cuarto_piso, final_lvl, lista_plataforma_final, (70, 740), "lvl 2", self.nivel_dos_completado)